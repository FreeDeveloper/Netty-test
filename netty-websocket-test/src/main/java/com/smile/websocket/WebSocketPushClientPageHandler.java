...
@Sharable
public final class WebSocketPushClientPageHandler extends SimpleChannelInboundHandler<FullHttpRequest> {

    static final WebSocketPushClientPageHandler INSTANCE = new WebSocketPushClientPageHandler();

    WebSocketPushClientPageHandler() {
    }
